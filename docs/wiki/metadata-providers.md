...
- 将`AVBASE`的优先级设置为 1000：`export MT_MT_PROVIDER_AVBASE__PRIORITY=1000`
- 将`GFriends`的优先级设置为 99：`export MT_PROVIDER_GFRIENDS__PRIORITY=99`
- 将`JavBus`从刮削源中移除（设置为 0）：`export MT_MT_PROVIDER_JAVBUS__PRIORITY=0`
